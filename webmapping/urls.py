...
urlpatterns = [
    ...
    url(r'^machines/point', views.PndMachinePointView.as_view(), name='pndmachine-nearme'),
    url(r'^outlets/point', views.PndOutletPointView.as_view(), name='pndoutlet-nearme'),
]
